...
-- Command     : write_vhdl -force -mode funcsim -rename_top MainBlockDesign_seg7_hex_0_1 -prefix
--               MainBlockDesign_seg7_hex_0_1_ MainBlockDesign_seg7_hex_0_0_sim_netlist.vhdl
...
entity MainBlockDesign_seg7_hex_0_1_seg7_hex is
  port (
...
end MainBlockDesign_seg7_hex_0_1_seg7_hex;

architecture STRUCTURE of MainBlockDesign_seg7_hex_0_1_seg7_hex is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MainBlockDesign_seg7_hex_0_1 is
  port (
    x : in STD_LOGIC_VECTOR ( 15 downto 0 );
    clk : in STD_LOGIC;
    clr : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of MainBlockDesign_seg7_hex_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of MainBlockDesign_seg7_hex_0_1 : entity is "MainBlockDesign_seg7_hex_0_0,seg7_hex,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of MainBlockDesign_seg7_hex_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of MainBlockDesign_seg7_hex_0_1 : entity is "seg7_hex,Vivado 2018.1";
end MainBlockDesign_seg7_hex_0_1;

architecture STRUCTURE of MainBlockDesign_seg7_hex_0_1 is
...
inst: entity work.MainBlockDesign_seg7_hex_0_1_seg7_hex
     port map (
